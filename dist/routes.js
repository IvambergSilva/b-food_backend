...
const OrderDetailsController_1 = require("./controllers/order/OrderDetailsController");
...
router.get('/order/details', isAuthenticated_1.isAuthenticated, new OrderDetailsController_1.OrderDetailsController().handle);
